...
namespace FinanceApp.Core.Services
{
    public class TreasuryBondService : CrudServiceBase
    {
        ...
        public async Task<List<TreasuryBondDto>> GetAllAsync(CustomIdentityUser user)
        {
        ...
        public async Task<TreasuryBondDto> GetSingleAsync(CustomIdentityUser user, int id)
        {
